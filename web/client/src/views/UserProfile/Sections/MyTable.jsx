            ...
            <Table className={classes.table}>
                <TableHead>
                    <TableRow>
                        ...
                        <CustomTableCell align="right">Show </CustomTableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {player.matchesHistory.map(row => (
                        <TableRow className={classes.row} key={row.id}>
                            ...
                            {row.show ? (<CustomTableCell align="right"><Switch defaultChecked value="checkedF" color="primary" /></CustomTableCell>) : null}
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
